...
import cv2
import tempfile
from ultralytics import YOLO  # Import YOLO instead of YOLOv10

def yolov10_inference(image, video, model_id, image_size, conf_threshold):
    # Use the YOLO class and specify the YOLOv10 model architecture
    model = YOLO(f'jameslahm/{model_id}')
    if image:
...
with gradio_app:
    ...
    with gr.Row():
        with gr.Column():
            app()
# Correct the variable name to _name_
